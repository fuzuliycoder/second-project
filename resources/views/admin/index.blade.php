...
@section('content')
  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div> <a href="{{route('infoshow')}}">Messages</a></div>
      <div> <a href="{{route('admin.create')}}">Input files</a></div>
      <div> <a href="{{route('admin.showpic')}}">Show pictures and files</a></div>
      <div> <a href="{{route('product.index')}}">Show Products</a></div>
      <div> <a href="{{route('category.index')}}">Show Categories</a></div>
      <div> <a href="{{route('post.index')}}">Show Posts</a></div>
